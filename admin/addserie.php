...
<body>
  ...
  if(isset($_POST['submit'])){
    ...
    if(!isset($error)){
        ...
        $stmt = $db->prepare('INSERT INTO serie (titulo, img, sinopse, acao, comedia, ficcao, terror, policial, animacao, drama, romance, infantil)
                                    VALUES (:titulo, :img, :sinopse, :acao, :comedia, :ficcao, :terror, :policial, :animacao, :drama, :romance, :infantil)') ;
        $stmt->execute(array(
          ':titulo' => $titulo,
          ':img' => $img,
          ':sinopse' => $sinopse,
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" name="titulo" id="titulo" value='<?php if(isset($error)){ echo $_POST['titulo'];}?>'  placeholder="TITULO DA SÉRIE">
  </div>
  <div class="form-group">
...
<div class="form-check form-check-inline">
  ...
  <div class="form-group">
    <label for="imglink">Link da imagem</label>
  ...
  <div class="form-group">
    ...
    <textarea class="form-control" id="sinopse" name="sinopse" rows="15" cols="100"><?php if(isset($error)){ echo $_POST['embed'];}?></textarea>
  </div>
